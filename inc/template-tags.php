 ...
 * @return bool
 */
function harapeko_2016__categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'harapeko_2016__categories' ) ) ) {
		...
		set_transient( 'harapeko_2016__categories', $all_the_cool_cats );
	}

	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so harapeko_2016__categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so harapeko_2016__categorized_blog should return false.
		return false;
	}
}
